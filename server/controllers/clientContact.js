...
exports.newClientContact = (req, res) => {
...
exports.getClientContact = (req, res) => {
  ...
  ClientContact.findOne(
    { _id: id, isDelete: false, userId: user._id },
    (err, clientContact) => {
      if (err) {
        return res.status(500).json({
          errors: { common: { msg: err.message } },
...
exports.deletePaymentMethod = async (req, res) => {
  try {
    ...
    let filteredMethods = client.paymentMethods.filter(
...
exports.updateBillingInfo = async (req, res) => {
  try {
    ...
    if (isNaN(zipCode)) {
      return res
        .status(400)
        .json({ common: { message: "Zip code must be a numeric value" } });
    }
    ...
    client.billingAddress = {
      ...
      addressLineOne: addressLineOne
        ? addressLineOne
        : client.billingAddress.addressLineOne,
      addressLineTwo: addressLineTwo
        ? addressLineTwo
        : client.billingAddress.addressLineTwo,
